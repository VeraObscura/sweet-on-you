...
export const TitleText = ({ name }: TitleTextProps) => {
  return <h1 className={styles.interTitle__characterNameText}>{name}</h1>;
};

export const CharacterDialogueText = ({ text }: CharacterDialogueProps) => {
  return (
    <h1 className={styles.interTitle__characterDialogueText}>{`"${text}"`}</h1>
  );
};
